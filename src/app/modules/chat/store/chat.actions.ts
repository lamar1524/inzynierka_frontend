...
import { IMessage, IResponseMessages } from '../../../interfaces/message.interface';
...
export const loadMessagesSuccess = createAction('[Chat] Load messages success', props<{ messages: IResponseMessages }>());
